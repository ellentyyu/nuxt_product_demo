...
import { e as eventHandler, s as setResponseHeader, a as send, b as getResponseStatus, c as setResponseStatus, u as useNitroApp, f as setResponseHeaders, j as joinRelativeURL, h as useRuntimeConfig, g as getQuery, i as createError, k as getRouteRules, l as getResponseStatusText } from '../runtime.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/images/hippo-solid.svg"}],"style":[],"script":[],"noscript":[],"title":"旅遊時代來臨！孤獨旅遊獨家免費試用，全面體驗最新產品，快來參加並分享心得吧！"};
